    ...
    <div style={{ background: '#141414', color: '#f0f0f0', minHeight: '100vh' }}>
      ...
      <header style={{ background: 'rgba(10,10,10,0.97)', borderBottom: '1px solid rgba(255,255,255,0.07)', position: 'sticky', top: 0, zIndex: 50 }}>
        <div style={{ maxWidth: 1100, margin: '0 auto', padding: '0 24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: 54 }}>
          <a href="#about" style={{ display: 'flex', alignItems: 'center', gap: 8, textDecoration: 'none' }}>
            <div style={{ width: 30, height: 30, background: '#4a8c5c', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <Icon name="Building2" size={15} style={{ color: '#fff' }} />
            </div>
            <span style={{ fontFamily: 'Oswald, sans-serif', fontSize: '0.82rem', letterSpacing: '0.14em', textTransform: 'uppercase', color: '#f0f0f0' }}>Кировский район</span>
          </a>
          <nav style={{ display: 'flex', alignItems: 'center', gap: 24 }}>
            {[['#about','Главная'], ['#about-project','О проекте'], ['#contacts','Контакты']].map(([href, label]) => (
              <a key={href} href={href} style={{ fontFamily: 'Golos Text, sans-serif', fontSize: '0.8rem', color: '#aaa', textDecoration: 'none', letterSpacing: '0.03em', transition: 'color 0.2s' }}
      ...
      <footer style={{ background: '#0a0a0a', borderTop: '1px solid rgba(255,255,255,0.06)', padding: '24px' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 12 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            <div style={{ width: 26, height: 26, background: '#4a8c5c', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <Icon name="Building2" size={13} style={{ color: '#fff' }} />
            </div>
            <span style={{ fontFamily: 'Oswald, sans-serif', fontSize: '0.7rem', letterSpacing: '0.12em', color: '#444', textTransform: 'uppercase' }}>Кировский район · Астрахань</span>
          </div>
          <div style={{ display: 'flex', gap: 20 }}>
            {['Поддержка', 'О проекте', 'Обратная связь'].map(l => (
              <a key={l} href="#contacts" style={{ fontFamily: 'Golos Text, sans-serif', fontSize: '0.76rem', color: '#444', textDecoration: 'none', transition: 'color 0.2s' }}
